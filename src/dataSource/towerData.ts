...
export const towerStaticData: {[key in TowerName]: TowerStaticItem} = {
  'icestar': { name: '冰之星辉', explain: '向最前方的一个敌人发射一颗会使敌人减速的冰星。' },
  'nanqiang': { name: '破阵枪骑', explain: '往三个敌人发射子弹。', enemyList: [{enemyName:'zombie-1'},{enemyName:'zombie-2'},{enemyName:'zombie-3'}] },
  'ejiate': { name: '炼狱之爪', explain: '向一个敌人发射一连串的子弹。' },
  'jin': { name: '幽影射手', explain: '攻击范围更大，子弹伤害更高。' },
  'fengche': { name: '旋风利刃', explain: '发射一个旋转风车，风车可穿透敌人并造成伤害。', enemyList: [{enemyName:'zombie-1'},{enemyName:'zombie-2'}] },
  'ez': { name: '奥术弹幕', explain: '发射一个大范围的精准弹幕，可以穿透所有敌人并造成伤害.', enemyList: [{enemyName:'zombie-1'},{enemyName:'zombie-2'},{enemyName:'zombie-3'}] },
  'lanbo': { name: '烈焰熔炉', explain: '向附近区域发射火焰，对命中的所有敌人造成伤害。', enemyList: [{enemyName:'zombie-1', level: 1},{enemyName:'zombie-1', level: 2},{enemyName:'zombie-1', level: 3},{enemyName:'zombie-1', level: 4},{enemyName:'zombie-1', level: 5},{enemyName:'zombie-1', level: 6},{enemyName:'zombie-1', level: 7},{enemyName:'zombie-1', level: 8},{enemyName:'zombie-1', level: 9},{enemyName:'zombie-1', level: 10}] },
  'aixi': { name: '寒冰射手', explain: '最多往九个敌人发射冰箭，并使敌人减速。', enemyList: [{enemyName:'zombie-1'},{enemyName:'zombie-2'},{enemyName:'zombie-3'}] },
  'delaiwen': { name: '回旋战斧', explain: '往前方敌人处最多丢出两个会回收的斧头，斧头会处决生命值低于10%的敌人，并有10%几率使该敌人奖励翻倍。', enemyList: [{enemyName:'zombie-3',level:3},{enemyName:'zombie-3',level:3},{enemyName:'rugby', level: 3}] },
  'huonan': { name: '烈焰法师', explain: '对一名敌人喷射火焰，火焰将持续造成越来越高的伤害', enemyList: [{enemyName:'zombie-1'},{enemyName:'zombie-2'}]},
  'twitch': { name: '暗影毒师', explain: '每隔5秒往敌人的地上喷射毒液，路过的敌人将减速并受到持续的中毒效果，每隔1秒将叠加一层毒液效果，最大5层', enemyList: [{enemyName:'zombie-1'},{enemyName:'zombie-2',level:2},{enemyName:'zombie-3',level:3}]},
}
